        ...
        <div className="min-h-screen bg-[#0B0E11] flex flex-col justify-center items-center p-4 relative overflow-hidden">
            ...
            >
                <div className="mb-8 text-center">
                    ...
                    <p className="text-[#848E9C]">Welcome back, trader.</p>
                </div>
                ...
                <Card className="border-[#2B3139] bg-[#15181D]/80 backdrop-blur-xl shadow-2xl">
                    <CardHeader className="space-y-1 pb-6 border-b border-[#2B3139]">
                        <CardTitle className="text-2xl font-bold text-center text-[#EAECEF]">Log In</CardTitle>
                    ...
                    <CardContent className="pt-6 space-y-4">
                        <form onSubmit={handleLogin} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Link href="#" className="text-xs text-[#F7A600] hover:underline">Forgot password?</Link>
                                </div>
                                <div className="relative">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase"><span className="bg-[#15181D] px-2 text-[#848E9C]">Or continue with</span></div>
                        </div>
                    ...
                    <CardFooter className="justify-center border-t border-[#2B3139] pt-6 pb-6">
                        <p className="text-sm text-[#848E9C]">
                            Don't have an account? <Link href="/register" className="text-[#F7A600] hover:underline font-bold">Sign up</Link>
                        </p>
                    </CardFooter>
                </Card>
            </motion.div>
